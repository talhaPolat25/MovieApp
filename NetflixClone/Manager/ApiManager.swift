...
struct Constants{
    ...
    static let trendingMoviesUrl = "https://api.themoviedb.org/3/trending/all/day?api_key="
    static let popularMoviesUrl = "https://api.themoviedb.org/3/movie/popular?api_key=d&language=en-US&page=1"
    static let upComingMovieUrl = "https://api.themoviedb.org/3/movie/upcoming?api_key=d&language=en-US&page=1"
    static let trendingTvUrl = "https://api.themoviedb.org/3/trending/tv/week?api_key="
    static let topRated = "https://api.themoviedb.org/3/movie/top_rated?api_key=d&language=en-US&page=1"
    static let discoverMovies = "https://api.themoviedb.org/3/discover/movie?api_key=d&language=en-US&sort_by=vote_average.desc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate"
    static let imageFetchBaseUrl = "https://image.tmdb.org/t/p/w500"
    static let searchBaseUrl = "https://api.themoviedb.org/3/search/movie?api_key=&query="
